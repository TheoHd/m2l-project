                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Administration des paramètres de configurations</h4>
                                <p class="card-category"><b>9 paramètres</b> de configuration</p>
                                <br>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="">
                            <div style="padding: 10px;">
                                <form action="" class="row">
                                    <div class="col-md-3">
                                        <input type="text" name="collaborator" id="input"
                                               class="form-control input-search-collaborator" value=""
                                    ...
                                    <div class="col-md-4" style="text-align: right; padding-right: 30px;">
                                        <a href="" class="btn btn-success" data-toggle="modal"
                                           data-target="#modalAddConfig">Ajouter un paramètre</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <table class="table table-hover" <?php if ($params2) : ?> style="width: 50% !important;" <?php endif; ?>>
                                    ...
                                    <?php foreach ($params1 as $paramName => $paramValue) : ?>
                                        <tr>
                                            ...
                                            <!-- <td>app/config</td> -->
                                            <td>
                                                <a href="" rel="tooltip" title="" class="btn btn-primary btn-xs"
                                                   data-original-title="Modifier">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                                <a href="" rel="tooltip" title="" class="btn btn-danger btn-xs"
