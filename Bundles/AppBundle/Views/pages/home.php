    ...
    <?php endif; ?>
                    ...
                    <div class="element-wrapper remove-ajax-search">
                        ...
                        <div class="projects-list">
                            <?php foreach ($last3formations as $f) : ?>
                            <div class="project-box">
                                <div class="project-head">
                                    <div class="project-title">
                                        <h5><?= $f->getNom() ?> - <small><a href="<?= App::generateUrl('avis_formations', ['id' => $f->getId()]) ?>" style="letter-spacing:0;text-transform:none;">Ajouter un avis</a></small></h5>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="el-tablo highlight">
                                                        ...
                                                        <div class="value"><?= $f->getPrerequis() ?></div>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="el-tablo highlight">
                                                        <div class="label">Durée</div>
                                                        <div class="value"><?= $f->getDuree() ?>J</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="os-progress-bar blue">
                                                <div class="bar-labels">
                                                    ...
                                                    <div class="bar-label-right">
                                                        ...
                                                        <span class="info"><?= $f->noteTitle ?></span>
                                                    </div>
                                                </div>
                                                <div class="bar-level-1" style="width: 100%">
                                                    <div class="bar-level-3" style="width: <?= $f->notePercent ?>%"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
